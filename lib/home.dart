                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Text("totel=${playerProvider.playerModel.response![0].statistics![0].goals!.total.toString()}",style: TextStyle(color: Colors.black,fontSize: 18),),
                          Text("conceded=${playerProvider.playerModel.response![0].statistics![0].goals!.conceded.toString()}",style: TextStyle(color: Colors.black,fontSize: 18),),
                          Text("assists=${playerProvider.playerModel.response![0].statistics![0].goals!.assists.toString()}",style: TextStyle(color: Colors.black,fontSize: 18),),
                          Text("saves=${playerProvider.playerModel.response![0].statistics![0].goals!.saves.toString()}",style: TextStyle(color: Colors.black,fontSize: 18),),
                        ],
                      ),
                    ),
                    Container(
